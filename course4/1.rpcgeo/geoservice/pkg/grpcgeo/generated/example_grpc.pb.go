...
const (
	GeoService_AddressSearch_FullMethodName = "/example.GeoService/AddressSearch"
	GeoService_GeoCode_FullMethodName       = "/example.GeoService/GeoCode"
)
...
func (c *geoServiceClient) AddressSearch(ctx context.Context, in *SearchRequest, opts ...grpc.CallOption) (*SearchResponse, error) {
	...
	err := c.cc.Invoke(ctx, GeoService_AddressSearch_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _GeoService_AddressSearch_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: GeoService_AddressSearch_FullMethodName,
	}
...
var GeoService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "example.GeoService",
