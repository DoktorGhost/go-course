...
func (g *GeoService) AddressSearch(input entities.SearchRequest) (entities.Response, error) {
	...
	for _, r := range rawRes {
		...
		result.Addresses = append(result.Addresses, entities.Address{City: r.Data.City, Street: r.Data.Street, House: r.Data.House, Lat: r.Data.GeoLat, Lon: r.Data.GeoLon})
	}
